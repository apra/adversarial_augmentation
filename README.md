...
We then measure also the calibration of our network to find whether its output correctly predicts the class-belonging probability of the sample <img src="/tex/d9f34fbf0f435051be4ad1ed9cfb75e8.svg?invert_in_darkmode&sanitize=true" align=middle width=118.15617164999998pt height=24.65753399999998pt/>. When a low probability is selected the network should make more mistakes, thus showing that it is possible to make correct judgements on the certainty of the prediction based on the class-belonging probability that the network outputs.
